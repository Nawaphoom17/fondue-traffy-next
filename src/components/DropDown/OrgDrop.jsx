...
function OrgDrop({org, setOrg}) {
    const [selectedOption, setSelectedOption] = useState({ name: "หน่วยงานทั้งหมด", });
            ...
            {Show && (
                <div className={styles.list}>
                    {List.map((item, index) => (
                        <div key={index}>
                            <p
                                className={item.name === org.name ? styles.selected : ""}
                                onClick={() => {
                                    setOrg({ name: item.name })
                                    setShow(false)
                                }}>
                                {item.name}
                            </p>
